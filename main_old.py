from hardlibs.DRV8833.DRV8833 import DRV8833
from hardlibs.VL53L0.VL53L0 import VL53L0
from hardlibs.MPU6050.MPU6050 import MPU6050

from libs.encoder.encoder import Encoder

from config.definitions import LOG_PATH
from config.definitions import CONFIG_PATH
...
def main():
    ...
    with Encoder(
        ...
        sampling_time = 20  # run for 20 seconds
